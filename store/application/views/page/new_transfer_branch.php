...
<div class="col-sm-12">
			<form action="" method="post" id="stock_recieved_form">
				<div class="panel panel-default">
					<div class="panel-heading">New Stock Received From Branch
					 ...
					 <div class="row">
							...
							<div class="col-lg-3">
								<div class="form-group xs-pt-10">
								  ...
								  <select name="branch" required class="form-control select2_demo_2 input-sm" id="branch">
								  <option value="">Select Branch</option>
								<?php
									$customers =$this->stock->getBranches();
									foreach($customers as $customer){
								?>
									<option value="<?php echo $customer['SN'] ?>"><?php echo $customer['branch_name'] ?></option>
								<?php
									}
								?>
								</select>
