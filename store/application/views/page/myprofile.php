	...
	<div class="col-sm-12">
		...
		?>
								...
								<div class="panel-body">
									<form action="<?php  echo base_url('dashboard/myprofile');  ?>" method="post" accept-charset="utf-8">
										
											<div class="form-group">
												 <input type="text" value="<?php  echo $get->username  ?>" name="email" value="" id="email" maxlength="80" size="30" required="" placeholder="E-mail" autocomplete="off" class="input-sm form-control">
											</div>
												<div class="form-group">
