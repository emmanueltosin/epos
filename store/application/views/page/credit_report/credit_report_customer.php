		...
		<div class="panel panel-default">
				...
				<div class="tab-container">
                  <ul class="nav nav-tabs">
					...
					<li class="active"><a href="<?php  echo base_url('dashboard/credit_report_customer') ?>">Rep By Customer</a></li>
                ...
                <div class="panel-heading">Credit Report By Customer
                 <div class="tools">
				...
				<br/><br/><br/>
				  <table id="table3" class="table table-striped table-hover" style="font-size:12px;">
				<thead>
				  <tr>
					 <th  > Credit ID </th>
					  <th > Customer </th>
				...
				<tbody>
					...
					$status = array(
						...
						$ins = $this->stock->getCreditRange($from,$to,array('customer'=>$customer_id));
						$alltotal =0;
						$alldiscount =0;
						$allvat = 0;
						$allscharge = 0;
