		...
		<div class="panel panel-default">
				...
				<div class="tab-container">
                  <ul class="nav nav-tabs">
					<li class="active"><a href="<?php  echo base_url('dashboard/deposit_report') ?>">General Report</a></li>
                ...
                <div class="panel-heading">Deposit Report List(s)
                 <div class="tools">
		...
		?>
				...
				<tbody>
					...
					if(isset($_POST['from'])){
						...
						$deposits =$this->stock->getFullDepositRange($from,$to);
