...
<div class="col-sm-12">
	 ...
	 <div class="panel panel-default panel-table">
                <div class="panel-heading">Today's Credit List(s)
					<div class="tools">
						<a href="<?php echo base_url('dashboard/add_new_credit') ?>" class="btn btn-primary btn-sm">Add New Credit</a>
					</div>
                </div>
 ...
 <table id="table3" class="table table-striped table-hover table-fw-widget" style="font-size:12px;">
				...
				<tbody>
					...
					$status = array(
						...
						$ins = $this->stock->getCredits(array('date'=>date('Y-m-d')));
						$alltotal =0;
						$alldiscount =0;
						$allvat = 0;
						$allscharge = 0;
