	...
	?>
	 <div class="panel panel-default panel-table">
                <div class="panel-heading">Stock List(s)
                	<?php if($user['role'] == "Top Administrator" || $user['role'] == "Administrator" || $user['role'] =='Stock Officer'){ ?>
         ...
         foreach($stocks as $stock){
             ...
             if($stock['product_type']=="Packed") {
                 $total_cost +=$stock['whole_cost_price']*$stock['cartoon_qty'];
                 $total_selling+=$stock['whole_price']*$stock['cartoon_qty'];
             }
         }
				...
				<div class="panel-body panel-table">
					 ...
					 <div class="col-lg-4">
                            <div class="panel panel-flat">
                                <div class="panel-body">
                                    <center>Total Selling Price</center>
                                    <h4 align="center"><b>N<?php echo  number_format($total_selling,1) ?></b></h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="panel panel-flat">
                                <div class="panel-body">
                                    <center> Total Cost Price</center>
                                    <h4 align="center"><b>N<?php echo  number_format($total_cost,1) ?></b></h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="panel panel-flat">
                                <div class="panel-body">
                                    ...
                                    <h4 align="center"><b>N<?php echo  number_format($total_profit,1) ?></b></h4>
                                </div>
                            </div>
                        </div>
                    </div>
				 ...
				 <table id="table3" class="table table-striped table-hover table-fw-widget">
					...
					<tr>
                      ...
                      <?php
                        }elseif($user['role'] == "Stock Officer") {
                                ?>
                      	<div class="btn-group btn-space">
                        <button type="button" class="btn btn-default">Action</button>
