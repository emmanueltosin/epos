<div class="row">
	<div class="col-sm-12">
		...
		<div class="panel panel-default">
				...
				<div class="tab-container">
                  <ul class="nav nav-tabs">
                   <li><a href="<?php  echo base_url('dashboard/invoice_report') ?>">Invoice Report</a></li>
					<li class="active"><a href="<?php  echo base_url('dashboard/deposit_report_customer') ?>">Invoice Rep By Customer</a></li>
					<li><a href="<?php  echo base_url('dashboard/deposit_report_sales_rep') ?>">Invoice Rep By Sales Rep</a></li>
                   </ul>
                ...
                <div class="panel-heading">Invoice Report By Stock
                 <div class="tools">
