	...
	<div class="col-sm-12">
		...
		<div class="panel panel-default">
				...
				<div class="tab-container">
                  <ul class="nav nav-tabs">
					...
					<li class="active"><a href="<?php  echo base_url('dashboard/invoice_report_customer') ?>">Invoice Rep By Customer</a></li>
					<li><a href="<?php  echo base_url('dashboard/invoice_report_sales_rep') ?>">Invoice Rep By Sales Rep</a></li>
                  </ul>
                ...
                <div class="panel-heading">Invoice Report By Customer
                 <div class="tools">
		...
		<tbody>
					...
					$status = array(
						...
						$ins = $this->invoice->getInvoiceRange($from,$to,array('customer'=>$customer_id));
						$alltotal =0;
						foreach($ins as $in){
