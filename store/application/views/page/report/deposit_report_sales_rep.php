		...
		<div class="panel panel-default">
				...
				<div class="tab-container">
                  <ul class="nav nav-tabs">
					...
					<li  class="active"><a href="<?php  echo base_url('dashboard/deposit_report_sales_rep') ?>">Rep By Sales Rep</a></li>
                ...
                <div class="panel-heading">Deposit Report By Sales Rep
                 <div class="tools">
				...
				<tbody>
					...
					$status = array(
							...
							$deposits = $this->stock->getDepositRange($from,$to,array('sales_rep'=>$customer_id));
