  ...
  <div id="invoice-POS">
	...
	<p align="left">
      ...
      <div class="info" >
        ...
        <p align="left" > 
            Receipt ID : <?php echo $payment['deposit']['reciept_id']  ?></br>
            Date   : <?php echo $payment['deposit']['date_added']  ?></br>
            Sales Rep  : <?php echo $this->users->get_user_by_id($payment['deposit']['sales_rep'],1)->username; ?></br>
			<?php if(is_numeric($payment['deposit']['customer_id'])){  ?>
			<?php  $cuustomer = $this->settings->getCustomer($payment['deposit']['customer_id']); ?>
