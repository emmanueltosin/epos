...
<div class="">
<?php
if(is_numeric($payment['deposit']['customer'])){
$customer = $this->settings->getCustomer($payment['deposit']['customer']);
}else{
$customer = $payment['deposit']['customer'];	
}
$reservation = $this->stock->getCredit($payment['deposit']['credit_id']);
$items = array();
$rep = $this->db->from("users")->where("id",$payment['deposit']['user_id'])->get()->result_array()[0];
?>
<div class="container" >
    <div class="row">
        <div class="col-xs-12">
		...
		?>
			...
			<h2>Credit ID </h2><h3 class="pull-right"> # <?php echo $payment['deposit']['credit_id'] ?></h3>
    		</div>
    		<hr>
    		<div class="row">
    			<div class="col-xs-6">
