...
$reservation = $this->stock->getCredit($invoice['SN']);
...
<div class="container" >
    <div class="row">
		...
		?>
			...
			<h2>Sales Receipt </h2><h3 class="pull-right"> # <?php echo $invoice['credit_id'] ?></h3>
    		</div>
    		<hr>
    		<div class="row">
    			<div class="col-xs-6">
    				...
    				<strong>Sold To:</strong><br>
						...
						<?php  }else{ ?>
						Customer Name : Generic Clients <br/>
						Phone Number : 
						<?php } ?>
						<?php }else{ ?>
						Customer Name : Generic Clients <br/>
				...
				<div class="col-xs-6 ">
    				...
    				<strong>Sales Information:</strong><br>
						...
						Time : <?php echo $invoice['sales_time'] ?><br/>
						Credit ID :<?php echo $invoice['credit_id'] ?><br/>
    				</address>
    			</div>
