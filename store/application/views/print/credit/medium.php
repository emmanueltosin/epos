...
<div class="container col-md-4" >
    <div class="row">
		...
		?>
			...
			<h2>Sales Receipt </h2><h3 class="pull-right"> # <?php echo $payment['reciept_id'] ?></h3>
    		</div>
    		<hr>
    		<div class="row">
    			<div class="col-xs-6">
	...
	<?php $payment = $this->db->get_where('tbl_credit_sales',array('SN'=>$payment['credit_SN']))->result_array()[0]; ?>
	 <div class="row">
    	<div class="col-md-12">
