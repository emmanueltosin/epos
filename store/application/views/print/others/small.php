...
<div id="wrapper">
  <table  width="300">
	<tr>
		...
		<img width="80%" src="http://localhost/pos/store_assets/newnewlogo.png"/> 
		<h3 align="center" style="margin-top:0px;">INFORMATION TECHNOLOGY</h3>
		</th>
		<td width="50%" valign="top" style="font-size:10px">
			Number Of ProcessesNumber Of ProcessesNumber Of ProcessesNumber Of Processes
			Number Of ProcessesNumber Of ProcessesNumber Of Processes
			Number Of ProcessesNumber Of Processes
			<h2 style="margin-top:0px;">HOT LINE: 08051516565<h2>
		</td>
	</tr>
	<tr>
		<td colspan="2">
			<table border="1" width="100%">
				<tr>
					<th>
						...
						<h3 align="left" valign="top" style="margin-top:0px;">YUSUF OLATUNJI YUSUF</h3>
					</th>
					<th>
